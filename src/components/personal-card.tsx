...
const PersonalCard = () => {
  ...
  return (
    <Card className="xl:fixed top-20 2xl:items-center 2xl:top-[30%]  p-3 border-2 border-gray-300 dark:border-gray-700 text-center justify-center max-w-[350px] md:max-w-full  place-self-center">
      ...
      {show ? (
        <CardContent className="text-left mt-5 justify-start lg:hidden -ml-10 -mr-10 xl:mr-0 flex flex-col md:grid md:grid-cols-2 gap-5 transform transition hover:-translate-y-1">
        ...
        <CardContent className="text-left mt-5 justify-center m-auto hidden lg:block">
          <div className="flex gap-2 m-5 ">
            <Card className="p-3">{personal.email.icon}</Card>
